...
#define VM_INTRINSICS_DO(do_intrinsic, do_class, do_name, do_signature, do_alias)                                       \
  ...
  do_signature(obj_int_obj_obj_int_int_bool_signature,  "([Ljava/lang/Object;I[Ljava/lang/Object;[Ljava/lang/Object;II)Z")   \
  ...
  do_signature(obj_l_signature,          "(Ljava/lang/Object;)J")                                                       \
                                                                                                                        \
  do_intrinsic(_hash_put,                 java_lang_Object,       hash_put_name, obj_int_obj_obj_int_int_bool_signature,    F_R) \
